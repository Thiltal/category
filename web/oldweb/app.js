...
a.length=b},
t:function(a,b){if(b>=a.length||b<0)throw H.b(P.N(b,null,null))
return a[b]},
...
z.dZ=new H.fP(null)
return z.h7(a)}},
Hh:function(a){if(init.globalState.ji)return new H.Iw(null).QS(a)
else return a},
...
z=this.lJ
z.Rz(0,a)
if(z.hr===0){for(z=this.C9;z.length!==0;){y=z.pop()
...
z=this.kJ
if(z.hr===0){if(this.pa&&this===init.globalState.yc)return
...
for(x=new P.zQ(z,z.HU,null,null),x.Qx=z.In;x.G();)x.gl().wR(0,y)},
...
this.kJ.V1(0)
z=this.Jp
if(z!=null){for(z=new H.a7(z,z.length,0,null);z.G();)z.lo.wR(0,null)
this.Jp=null}},"$0","gIm",0,0,3]},
NY:{
"^":"Tp:3;a",
$0:function(){this.a.wR(0,null)}},
cC:{
"^":"a;Rk,yy",
...
z=this.Jc()
if(z==null){if(init.globalState.yc!=null&&init.globalState.i2.x4(init.globalState.yc.jO)&&init.globalState.Ai&&init.globalState.yc.Gx.hr===0)H.vh(P.FM("Program exited with open ReceivePorts."))
y=init.globalState
if(y.EF&&y.i2.hr===0&&y.Xz.yy===0){y=y.rj
...
z=y}else z=!1
return z},
gEo:function(a){return this.kx.TU},
$isJM:true,
$isbC:true,
$isEq:true},
Ua:{
...
return z},
gEo:function(a){return(this.Bi<<16^this.fI<<8^this.ma)>>>0},
$isns:true,
$isbC:true,
$isEq:true},
yo:{
...
F4:function(){var z,y
for(z=this.MD.length,y=0;y<z;++y)this.MD[y].__MessageTraverser__attached_info__=null
this.MD=null}},
X1:{
"^":"a;",
...
VX:{
"^":"Tp:0;c",
$1:function(a){return this.c(a)}}}],["","",,S,{
"^":"",
Iq:[function(){var z,y
$.Sm=S.CH()
z=new XMLHttpRequest()
C.Dt.EP(z,"POST","/app_state")
y=H.VM(new W.RO(z,"load",!1),[null])
H.VM(new W.xC(0,y.J6,y.fA,W.VF(new S.em(z)),y.el),[H.Kp(y,0)]).DN()
z.setRequestHeader("X-Requested-With","XMLHttpRequest")
z.setRequestHeader("Content-Type","text/json; charset=UTF-8")
z.send("{\"appStateRequested\": true}")},"$0","KW",0,0,1],
zu:{
"^":"a;J4,tC,Nn,yI,kw,Ei,BG,iO,Ir,nI,Tx",
bc:function(){this.EZ()
J.eX(this.Tx.style,"block")
this.Nn=S.f7(this.Tx)},
AM:function(){this.EZ()
var z=this.Ei
J.GD(z.X8,"Login")
z=z.X8
z.toString
new W.I4(z).Rz(0,"loadingInProgress")
J.eX(this.iO.style,"block")},
EZ:function(){J.eX(this.kw.style,"none")
J.eX(this.J4.style,"none")
J.eX(this.iO.style,"none")
J.eX(this.Ir.style,"none")
J.eX(this.nI.style,"none")
J.eX(this.BG.style,"none")
J.eX(this.Tx.style,"none")},
Jl:function(){var z,y
z=document.querySelector("#new_user")
this.J4=z
this.tC=S.II(z)
z=document.querySelector("#login")
this.kw=z
this.Ei=S.eU(z)
this.BG=document.querySelector("#loadingScreen")
this.iO=document.querySelector("#welcome")
this.Ir=document.querySelector("#map")
this.nI=document.querySelector("#feedback")
this.Tx=document.querySelector("#problemList")
y=new S.Dd(this)
z=H.VM(new W.RO(window,"resize",!1),[null])
H.VM(new W.xC(0,z.J6,z.fA,W.VF(y),z.el),[H.Kp(z,0)]).DN()
y.$1(null)
this.EZ()
z=J.Vg(document.querySelector("#login_button"))
H.VM(new W.xC(0,z.J6,z.fA,W.VF(new S.VB(this)),z.el),[H.Kp(z,0)]).DN()
z=J.Vg(document.querySelector("#new_account"))
H.VM(new W.xC(0,z.J6,z.fA,W.VF(new S.DE(this)),z.el),[H.Kp(z,0)]).DN()},
static:{CH:function(){var z=new S.zu(null,null,null,null,null,null,null,null,null,null,null)
z.Jl()
return z}}},
Dd:{
"^":"Tp:12;a",
$1:function(a){var z=this.a.BG.style
J.RE(z).sR(z,H.d(window.innerWidth)+"px")
C.rd.sfg(z,H.d(window.innerHeight)+"px")}},
VB:{
"^":"Tp:12;b",
...
y=J.qO(z.kw.style)
x=z.kw
if(y!=="none")J.eX(x.style,"none")
else{J.eX(x.style,"block")
J.eX(z.J4.style,"none")}}},
DE:{
"^":"Tp:12;c",
$1:function(a){var z,y,x
z=this.c
...
J.eX(z.kw.style,"none")}}},
em:{
"^":"Tp:14;a",
$1:function(a){var z,y,x
z=C.xr.kV(this.a.responseText)
y=z.x4("logged")&&z.t(0,"logged")
x=$.Sm
if(y)x.bc()
else x.AM()}},
V6:{
"^":"a;HF,YJ,X8",
wR:function(a,b){return this.X8.$1(b)},
Lt:function(){var z=P.Fl(null,null)
z.u(0,"nick",this.HF.value)
z.u(0,"password",this.YJ.value)
return z},
AB:function(a){var z,y
this.HF=a.querySelector("#login_nick")
this.YJ=a.querySelector("#login_password")
z=a.querySelector("#send_login")
this.X8=z
y=new S.Ax(this)
z.toString
...
H.VM(new W.xC(0,z.J6,z.fA,W.VF(new S.SE(y)),z.el),[H.Kp(z,0)]).DN()
z=this.YJ
z.toString
z=H.VM(new W.Cq(z,"keydown",!1),[null])
H.VM(new W.xC(0,z.J6,z.fA,W.VF(new S.C5(y)),z.el),[H.Kp(z,0)]).DN()},
static:{eU:function(a){var z=new S.V6(null,null,null)
z.AB(a)
return z}}},
Ax:{
"^":"Tp:12;a",
$1:function(a){var z,y,x
z=this.a
J.GD(z.X8,"Login in progres...")
y=z.X8
y.toString
new W.I4(y).h(0,"loadingInProgress")
x=new XMLHttpRequest()
C.Dt.EP(x,"POST","/login")
y=H.VM(new W.RO(x,"load",!1),[null])
H.VM(new W.xC(0,y.J6,y.fA,W.VF(new S.DS(x)),y.el),[H.Kp(y,0)]).DN()
x.setRequestHeader("X-Requested-With","XMLHttpRequest")
x.setRequestHeader("Content-Type","text/json; charset=UTF-8")
x.send(C.xr.mY(z.Lt()))}},
DS:{
"^":"Tp:14;b",
$1:function(a){var z=C.xr.kV(this.b.responseText)
if(z.x4("logged")&&z.t(0,"logged"))$.Sm.bc()
else window.alert("bad login")}},
SE:{
"^":"Tp:12;c",
$1:function(a){if(J.Zm(a)===13)this.c.$1(a)}},
C5:{
"^":"Tp:12;d",
$1:function(a){if(J.Zm(a)===13)this.d.$1(a)}},
c2:{
"^":"a;Lh,HF,YJ,Gt,w4,Yd,Ta,X8",
wR:function(a,b){return this.X8.$1(b)},
Lt:function(){var z=P.Fl(null,null)
z.u(0,"age",this.Lh.value)
z.u(0,"nick",this.HF.value)
z.u(0,"password",this.YJ.value)
z.u(0,"email",this.Gt.value)
z.u(0,"gender",this.w4.value)
z.u(0,"work",this.Ta.value)
z.u(0,"education",this.Yd.value)
return z},
a6:function(a){var z
this.Lh=a.querySelector("#new_user_age")
this.HF=a.querySelector("#new_user_nick")
this.YJ=a.querySelector("#new_user_password")
this.Gt=a.querySelector("#new_user_email")
this.w4=a.querySelector("#new_user_gender")
this.Yd=a.querySelector("#new_user_education")
this.Ta=a.querySelector("#new_user_work")
z=a.querySelector("#register_new_user")
this.X8=z
z.toString
z=H.VM(new W.Cq(z,"click",!1),[null])
H.VM(new W.xC(0,z.J6,z.fA,W.VF(new S.kT(this)),z.el),[H.Kp(z,0)]).DN()},
static:{II:function(a){var z=new S.c2(null,null,null,null,null,null,null,null)
z.a6(a)
return z}}},
kT:{
"^":"Tp:12;a",
...
z=new XMLHttpRequest()
C.Dt.EP(z,"POST","/save_user")
y=H.VM(new W.RO(z,"load",!1),[null])
H.VM(new W.xC(0,y.J6,y.fA,W.VF(new S.EZ()),y.el),[H.Kp(y,0)]).DN()
z.setRequestHeader("X-Requested-With","XMLHttpRequest")
z.setRequestHeader("Content-Type","text/json; charset=UTF-8")
...
Jd:{
"^":"a;pV,F8",
cB:function(a){var z,y,x,w,v,u,t,s,r,q,p,o,n,m
z=[]
y=a.xL.length
for(x=this.pV,x=new H.a7(x,x.length,0,null);x.G();){w=x.lo
if(w===a)continue
v=w.xL
u=v.length
t=u>y?u:y
for(v=new H.a7(v,u,0,null),s=0;v.G();){r=v.lo
for(q=a.xL,q=new H.a7(q,q.length,0,null);q.G();){p=q.lo
o=r.eT
n=p.eT
if(o==null?n==null:o===n){o=r.wz
n=p.wz
n=o==null?n==null:o===n
o=n}else o=!1
if(o)++s}}z.push(s/t)}for(x=new H.a7(z,z.length,0,null),m=0;x.G();)m+=x.lo
x=z.length
if(x===0)return
return m/x*100},
Ww:function(){var z,y,x,w,v,u,t
for(z=this.pV,z=new H.a7(z,z.length,0,null),y=0,x=0;z.G();){w=z.lo
v=C.jn.BU(w.Bm-w.yQ,1000)
if(v>y)y=v
x+=v}u=this.cB(J.MQ(this.pV))
t="<div>\n        <h1>Feedback</h1>\n        <span class=\"conformity_level\">Conformity level: "+(u==null?"Your result is first one":C.CD.Sy(u,2))+"</span><br>\n        <span>Number of solutions: "+this.pV.length+"</span><br>\n        <button id=\"anotherIssue\">Another issue</button>\n</div>\n    "
J.Qy(this.F8,t)
z=J.Vg(this.F8.querySelector("#anotherIssue"))
H.VM(new W.xC(0,z.J6,z.fA,W.VF(new S.Qo()),z.el),[H.Kp(z,0)]).DN()},
...
w=this.pV
v=new S.cg(null,null,null,null,null)
v.Zw(x)
w.push(v)}this.Ww()},
static:{ac:function(a,b){var z=new S.Jd(null,a)
z.BS(a,b)
return z}}},
Qo:{
"^":"Tp:12;",
...
this.yQ=a.t(0,"start_time")
this.Bm=a.t(0,"end_time")
this.OV=a.t(0,"user_id")
z=C.xr.kV(a.t(0,"solution"))
this.xL=[]
for(y=J.GP(z);y.G();){x=y.gl()
w=this.xL
v=new S.Ry(null,null)
v.eT=x.t(0,"parent")
v.wz=x.t(0,"child")
w.push(v)}},
Lt:function(){var z=P.Fl(null,null)
z.u(0,"problemId",C.jN.gjO(this.UD))
z.u(0,"startTime",this.yQ)
z.u(0,"endTime",this.Bm)
z.u(0,"solution",C.xr.mY(this.b8()))
return z},
b8:function(){var z,y,x,w
z=[]
for(y=this.xL,y=new H.a7(y,y.length,0,null);y.G();){x=y.lo
x.toString
w=P.Fl(null,null)
w.u(0,"parent",x.eT)
w.u(0,"child",x.wz)
...
"^":"a;eT,wz",
Lt:function(){var z=P.Fl(null,null)
z.u(0,"parent",this.eT)
z.u(0,"child",this.wz)
return z}},
n8:{
"^":"a;ph>,F8,wU,O7,KV>,wd>,Ho@,Fh,St,zD,OT,Ow,ew,a4",
guC:function(){return P.y(this.ew,this.a4)},
...
s=z.R
r=z.fg
return C.jn.yu(P.y(0,P.J(y+w,u+s)-P.y(y,u))*P.y(0,P.J(x+v,t+r)-P.y(x,t)))},
IT:function(a){var z,y,x
z=window.innerWidth
y=$.pa().j1(z-100)
z=window.innerHeight
x=$.pa().j1(z-100)
this.F8=new S.PY(y,x,100,30)
z=x+25
this.wU=new S.PY(y-15,z,50,20)
this.O7=new S.PY(y+25,z,50,20)}},
PY:{
"^":"a;x,y,R,fg"},
P4:{
"^":"a;pl,Yk,Ma",
VF:[function(a){var z,y,x,w,v,u,t,s,r,q,p,o,n,m,l,k,j,i,h,g
if(!this.pl){P.dT(P.k5(0,0,0,this.Ma,0,0),null,null).ml(this.gaQ())
return}this.xW()
z=window.innerWidth/2
y=window.innerHeight/2
x=[]
for(w=$.b4.ni,w=new H.a7(w,w.length,0,null);w.G();)x.push(new S.Lu(w.lo,[]))
for(w=new H.a7(x,x.length,0,null);w.G();){v=w.lo
for(u=new H.a7(x,x.length,0,null);u.G();){t=u.lo
if(J.de(t,v))continue
s=v.gH()
r=t.gH()
q=s.F8.x
p=r.F8.x
...
if(l<10)l=10
if(m===0)m=10
k=-(l/Math.pow(m,1.5))/30
q=v.GV
p=r.F8
o=p.x
j=s.F8
j=new P.hL((o-j.x)*k/2,(p.y-j.y)*k)
j.$builtinTypeInfo=[null]
q.push(j)
p=s.F8
p=new P.hL((z-p.x)*0.002,(y-p.y)*0.002)
p.$builtinTypeInfo=[null]
q.push(p)
p=this.Yk
p=new P.hL(0,((p-v.H.Ho+1)*(window.innerHeight/(p+1))-s.F8.y)/50)
p.$builtinTypeInfo=[null]
q.push(p)}for(u=v.gGV(),u=new H.a7(u,u.length,0,null),i=0,h=0;u.G();){g=u.lo
i+=g.x
h+=g.y}u=v.H
q=u.F8.x+C.CD.yu(i)
p=u.F8
p.x=q
if(q>window.innerWidth-100){q=window.innerWidth-100
p.x=q}if(q<0)p.x=0
q=p.y+C.CD.yu(h)
u=u.F8
u.y=q
if(q>window.innerHeight-100){q=window.innerHeight-100
u.y=q}if(q<0)u.y=0}P.dT(P.k5(0,0,0,this.Ma,0,0),null,null).ml(this.gaQ())},"$1","gaQ",2,0,15],
xW:function(){var z,y,x,w,v,u,t,s,r
for(z=$.b4.ni,z=new H.a7(z,z.length,0,null);z.G();){y=z.lo
if(J.q8(J.OG(y))===0)y.sHo(1)
else y.sHo(null)}for(x=1;x!==0;)for(z=$.b4.ni,z=new H.a7(z,z.length,0,null),x=0;z.G();){y=z.lo
if(y.Ho==null){for(w=y.wd,v=new H.a7(w,w.length,0,null),u=0,t=!0;v.G();){s=v.lo
if(s.gHo()!=null){r=s.Ho
if(r>u)u=r}else{++x
t=!1}}if(t){v=u+1
y.Ho=v
this.Yk=v
for(w=new H.a7(w,w.length,0,null);w.G();)w.lo.sHo(u)}}}},
static:{"^":"fk"}},
Lu:{
"^":"a;H<,GV<"},
MV:{
...
for(z=this.jo,z=new H.a7(z,z.length,0,null),y="";z.G();){x=z.lo
y+="        <div id=\"problem"+H.d(x.jO)+"\" class=\"problemRow\">"+H.d(x.QZ)+"</div>\r\n"}y+="<button id='logout'>Logout</logout>"
J.Qy(this.F8,y)
w=W.GN(this.F8.querySelectorAll(".problemRow"),null)
for(z=w.gA(w);z.G();){v=J.Vg(z.lo)
u=v.fA
t=v.el
s=new W.xC(0,v.J6,u,W.VF(new S.xl()),t)
s.$builtinTypeInfo=[H.Kp(v,0)]
v=s.H2
if(v!=null&&s.UU<=0)J.qV(s.J6,u,v,t)}z=J.Vg(document.querySelector("#logout"))
H.VM(new W.xC(0,z.J6,z.fA,W.VF(new S.Hb()),z.el),[H.Kp(z,0)]).DN()},
Fn:function(a){var z,y,x
z=document.querySelector("#logout")
if(z!=null)J.Qy(z,"Logout")
y=new XMLHttpRequest()
C.Dt.EP(y,"POST","/get_problems")
x=H.VM(new W.RO(y,"load",!1),[null])
H.VM(new W.xC(0,x.J6,x.fA,W.VF(new S.tN(this,y)),x.el),[H.Kp(x,0)]).DN()
y.setRequestHeader("X-Requested-With","XMLHttpRequest")
y.setRequestHeader("Content-Type","text/json; charset=UTF-8")
y.send("{\"getProblems\": true}")},
static:{f7:function(a){var z=new S.MV([],a)
z.Fn(a)
return z}}},
tN:{
"^":"Tp:14;a,b",
$1:function(a){var z,y,x,w
for(z=J.GP(C.xr.kV(C.xr.kV(this.b.responseText).t(0,"problems"))),y=this.a,x=y.jo;z.G();){w=new S.it(null,null,null,null)
w.Zw(z.gl())
x.push(w)}y.Ww()}},
xl:{
"^":"Tp:12;",
...
z.toString
H.Yx("")
y=H.BU(H.ys(z,"problem",""),null,null)
z=$.Sm
z.EZ()
J.eX(z.Ir.style,"block")
$.b4=S.lY(y)}},
Hb:{
"^":"Tp:12;",
$1:function(a){var z,y
J.Qy(H.Go(J.l2(a),"$iscv"),"logout in progres ...")
z=new XMLHttpRequest()
C.Dt.EP(z,"POST","/logout")
y=H.VM(new W.RO(z,"load",!1),[null])
H.VM(new W.xC(0,y.J6,y.fA,W.VF(new S.MO()),y.el),[H.Kp(y,0)]).DN()
z.setRequestHeader("X-Requested-With","XMLHttpRequest")
z.setRequestHeader("Content-Type","text/json; charset=UTF-8")
z.send("{\"getProblems\": true}")}},
MO:{
"^":"Tp:14;",
$1:function(a){$.Sm.AM()}},
it:{
"^":"a;jO,le,QZ,Tq",
bu:function(a){return H.d(this.jO)+" "+H.d(this.le)+" "+H.d(this.QZ)+" "+H.d(this.Tq)},
Zw:function(a){this.jO=a.t(0,"id")
this.QZ=a.t(0,"description")
if(a.x4("properties"))this.le=a.t(0,"properties")
if(a.x4("taglist"))this.Tq=a.t(0,"taglist")},
Lt:function(){var z,y
z=P.Fl(null,null)
z.u(0,"id",this.jO)
z.u(0,"description",this.QZ)
y=this.le
if(y!=null)z.u(0,"properties",y)
y=this.Tq
if(y!=null)z.u(0,"taglist",y)
return z}},
JE:{
"^":"a;ni,oF,uO,jO,KP,GB",
cP:function(){var z,y
z=document.querySelector("#mapCanvas")
z.width=window.innerWidth
z.height=window.innerHeight
y=document.body.style
J.RE(y).sR(y,H.d(window.innerWidth)+"px")
C.rd.sfg(y,H.d(window.innerHeight)+"px")
y=new S.o6(z,null,null,null,null,null,null,null,null,0)
y.G4(z)
$.qN=y
y=J.Vg(document.querySelector("#sendMapSolution"))
H.VM(new W.xC(0,y.J6,y.fA,W.VF(new S.BZ(this)),y.el),[H.Kp(y,0)]).DN()},
H1:function(){var z,y,x,w,v
z=[]
y=[]
for(x=this.ni,x=new H.a7(x,x.length,0,null);x.G();){w=x.lo
v=J.RE(w)
z.push(v.gph(w))
if(v.gKV(w)!=null)y.push(P.EF(["parent",J.Y3(v.gKV(w)),"child",v.gph(w)],null,null))}return P.EF(["all",z,"joins",y],null,null)},
lD:function(){var z,y,x,w
z=this.H1()
z.u(0,"startTime",this.KP)
z.u(0,"endTime",Date.now())
z.u(0,"mapId",this.jO)
y=C.xr.mY(z)
P.JS(y)
x=new XMLHttpRequest()
C.Dt.EP(x,"POST","/solve_problem")
w=H.VM(new W.RO(x,"load",!1),[null])
H.VM(new W.xC(0,w.J6,w.fA,W.VF(new S.i1(x)),w.el),[H.Kp(w,0)]).DN()
x.setRequestHeader("X-Requested-With","XMLHttpRequest")
x.setRequestHeader("Content-Type","text/json; charset=UTF-8")
x.send(y)},
Js:[function(a){var z,y
for(z=this.oF,z=new H.a7(z,z.length,0,null);z.G();)z.lo.$0()
z=window
y=this.gca()
C.ol.y4(z)
C.ol.ne(z,W.VF(y))},"$1","gca",2,0,16],
iQ:function(){var z,y,x,w,v,u,t,s,r
for(z=this.ni,y=new H.a7(z,z.length,0,null),x=1500,w=1500,v=0,u=0;y.G();){t=y.lo.F8
s=t.x
if(x>s)x=s
r=t.y
if(w>r)w=r
if(v<s)v=s
if(u<r)u=r}return new S.PY(x,w,v-x+C.Nm.gtH(z).F8.R,u-w+C.Nm.gtH(z).F8.fg)},
m9:function(a){var z
for(z=this.ni,z=new H.a7(z,z.length,0,null);z.G();)if(C.Nm.Rz(z.lo.wd,a));},
rm:function(a){var z,y
this.jO=a
z=new XMLHttpRequest()
C.Dt.EP(z,"POST","/get_problem")
y=H.VM(new W.RO(z,"load",!1),[null])
H.VM(new W.xC(0,y.J6,y.fA,W.VF(new S.iY(this,z)),y.el),[H.Kp(y,0)]).DN()
z.setRequestHeader("X-Requested-With","XMLHttpRequest")
z.setRequestHeader("Content-Type","text/json; charset=UTF-8")
z.send("{\"mapId\": "+H.d(a)+"}")},
static:{"^":"Gu",lY:function(a){var z=new S.JE([],[],null,null,null,0)
z.rm(a)
return z}}},
iY:{
"^":"Tp:14;a,b",
...
z=this.a
z.cP()
y=new S.it(null,null,null,null)
y.Zw(C.xr.kV(this.b.responseText).t(0,"problem"))
x=y.le.split(",")
for(w=new H.a7(x,x.length,0,null),v=z.ni;w.G();){u=w.lo
t=new S.n8(u,null,null,null,null,[],null,!1,!1,!1,!1,!1,null,null)
t.IT(u)
v.push(t)}w=new S.P4(!1,1,50)
w.VF(null)
z.uO=w
w.pl=!0
z.KP=Date.now()
...
$1:function(a){var z,y
z=$.Sm
y=C.xr.kV(this.a.responseText)
z.EZ()
J.eX(z.nI.style,"block")
z.yI=S.ac(z.nI,y)}},
o6:{
"^":"a;qN,Ee,cZ,Nu,Xx,yA,RS,Oy,uV,CA",
Cc:[function(){var z,y,x,w,v,u,t,s,r,q,p
if(C.jn.Y(this.CA++,60)===0){z=window.innerWidth
y=window.innerHeight
this.Ee.clearRect(0,0,z,y)}else{x=$.b4.iQ()
this.Ee.clearRect(x.x-80,x.y-80,x.R+160,x.fg+160)}for(w=$.b4.ni,w=new H.a7(w,w.length,0,null);w.G();){v=w.lo
if(v.KV!=null){this.Ee.beginPath()
u=this.Ee
t=v.F8
u.moveTo(t.x+C.jn.BU(t.R,2),t.y+C.jn.BU(t.fg,2))
t=this.Ee
u=v.KV.F8
t.lineTo(u.x+C.jn.BU(u.R,2),u.y+C.jn.BU(u.fg,2))
this.Ee.stroke()
this.Ee.closePath()}}for(w=$.b4.ni,w=new H.a7(w,w.length,0,null);w.G();){v=w.lo
u=v.wU
t=v.F8
u.x=t.x+25
u.y=t.y-15
...
u=this.Ee
u.fillStyle="white"
u.fillRect(t.x,t.y,t.R,t.fg)
t=this.Ee
t.strokeStyle="black"
u=v.F8
t.strokeRect(u.x,u.y,u.R,u.fg)
u=this.Ee
u.fillStyle="black"
u.font="14px Arial"
t=v.ph
...
s=s.y
u.toString
u.fillText(t,r+10,s+17)
if(v.Ow){q=v.O7
u=this.Ee
u.fillStyle="yellow"
u.fillRect(q.x,q.y,q.R,q.fg)}if(v.OT){p=v.wU
u=this.Ee
u.fillStyle="yellow"
u.fillRect(p.x,p.y,p.R,p.fg)}if(v.St){q=v.O7
this.Ee.strokeRect(q.x,q.y,q.R,q.fg)}if(v.zD){p=v.wU
this.Ee.strokeRect(p.x,p.y,p.R,p.fg)}}},"$0","gwK",0,0,3],
DU:[function(a){var z,y,x
a.preventDefault()
z=H.VM(new P.hL(a.pageX,a.pageY),[null])
y=this.Fk(J.XH(z.x),J.XH(z.y))
this.cZ=y
if(y!=null){$.b4.uO.pl=!1
this.Xx=J.XH(H.VM(new P.hL(a.pageX,a.pageY),[null]).x)
this.yA=J.XH(H.VM(new P.hL(a.pageX,a.pageY),[null]).y)
y=this.cZ
x=y.F8
this.RS=x.x
this.Oy=x.y
...
w=this.cZ
if(w==null){w=this.qN
if(this.Fk(y,x)!=null)J.WB(w.style,"pointer")
else J.WB(w.style,"")
return}v=this.Xx
u=this.RS
w=w.F8
w.x=y-v+u
w.y=x-this.yA+this.Oy
t=[]
for(w=$.b4.ni,w=new H.a7(w,w.length,0,null);w.G();){s=w.lo
v=this.cZ
if(s==null?v==null:s===v){s.St=!1
s.zD=!1
continue}s.ew=v.t7(s.wU)
s.OT=!1
s.a4=this.cZ.t7(s.O7)
s.Ow=!1
t.push(s)
v=this.cZ.F8.x
u=s.F8.x
...
r=s.F8.y
u=Math.pow(u-r,2)
if(Math.sqrt(v+u)<200){s.St=!0
s.zD=!0}else{s.St=!1
s.zD=!1}}C.Nm.uy(t,"sort")
H.ZE(t,0,t.length-1,new S.v6())
w=C.Nm.grZ(t)
if(P.y(w.ew,w.a4)!==0){w=C.Nm.grZ(t)
this.Nu=w
if(w.ew>w.a4)w.OT=!0
else w.Ow=!0}else this.Nu=null},"$1","gYZ",2,0,17],
Fb:[function(a){var z,y,x
z=this.cZ
if(z!=null&&this.Nu!=null){y=this.Nu
z.toString
if(y.Ow){z.KV=y
$.b4.m9(z)
y.wd.push(z)}else if(y.OT){y.KV=z
$.b4.m9(y)
z.wd.push(y)}z=this.Nu
z.Ow=!1
z.OT=!1}for(z=$.b4.ni,z=new H.a7(z,z.length,0,null);z.G();){x=z.lo
x.St=!1
x.zD=!1}this.cZ=null
$.b4.uO.pl=!0},"$1","gJ3",2,0,15],
Fk:function(a,b){var z,y,x,w,v
for(z=$.b4.ni,z=new H.a7(z,z.length,0,null);z.G();){y=z.lo
x=y.F8
w=x.x
if(a>w){v=x.y
x=b>v&&a<w+x.R&&b<v+x.fg}else x=!1
if(x)return y}return},
G4:function(a){var z,y,x,w
z=this.qN
this.Ee=z.getContext("2d")
$.b4.oF.push(this.gwK())
y=H.VM(new W.Cq(z,"mousedown",!1),[null])
H.VM(new W.xC(0,y.J6,y.fA,W.VF(this.gAL()),y.el),[H.Kp(y,0)]).DN()
y=H.VM(new W.Cq(z,"mousemove",!1),[null])
H.VM(new W.xC(0,y.J6,y.fA,W.VF(this.gYZ()),y.el),[H.Kp(y,0)]).DN()
y=H.VM(new W.Cq(z,"mouseup",!1),[null])
H.VM(new W.xC(0,y.J6,y.fA,W.VF(this.gJ3()),y.el),[H.Kp(y,0)]).DN()
z=H.VM(new W.Cq(z,"mouseout",!1),[null])
H.VM(new W.xC(0,z.J6,z.fA,W.VF(this.gJ3()),z.el),[H.Kp(z,0)]).DN()
z=window.innerWidth
y=window.innerHeight
...
w=x.getContext("2d")
w.fillStyle="white"
w.fillRect(0,0,window.innerWidth,window.innerHeight)}},
v6:{
"^":"Tp:11;",
$2:function(a,b){return C.jn.yu(a.guC()-b.guC())}}},1],["","",,H,{
"^":"",
...
if(b<0||z>=this.gKN())throw H.b(P.TE(b,0,this.gB(this),null,null))
...
for(z=new H.a7(a,a.length,0,null);z.G();)if(b.$1(z.lo))return!0
...
P.HZ(this,z)},function(a){return this.ZL(a,null)},"yk","$2","$1","gFa",2,2,19,20],
$isvs:true,
$isb8:true,
static:{"^":"Gn,Jp,cp,Cd,NK",k3:function(a,b){b.YM=2
...
T9:[function(a){return J.le(a)},"$1","rm",2,0,5],
...
rk:function(a){return J.le(a)&0x3ffffff},
...
for(y=0;y<this.gB(a);++y)z[y]=this.t(a,y)
return z},
br:function(a){return this.tt(a,!0)},
bu:function(a){return P.WE(a,"[","]")},
$iszM:true,
...
tp:[function(a){return a.Lt()},"$1","DY",2,0,6],
uw:{
"^":"a;EK,LK,Mq",
...
z=a.length
for(y=J.rY(a),x=0,w=0;w<z;++w){v=y.j(a,w)
if(v>92)continue
...
E5:function(a){this.SK.pop()},
QD:function(a){var z,y,x,w
if(this.tM(a))return
this.Jn(a)
try{z=this.HT(a)
if(!this.tM(z)){x=P.Gy(a,null)
throw H.b(x)}this.SK.pop()}catch(w){x=H.Ru(w)
y=x
throw H.b(P.Gy(a,y))}},
tM:function(a){var z
...
K6:function(a){this.jg.IN+=a},
pN:function(a,b,c){var z=C.xB.Nj(a,b,c)
this.jg.IN+=z},
...
return this.m5===b.m5},
gEo:function(a){return this.m5&0x1FFFFFFF},
...
for(y=this.dA.className.split(" "),y=new H.a7(y,y.length,0,null);y.G();){x=J.rr(y.lo)
...
u:function(a,b,c){J.ZP(this.gd3()[b],c)},
...
I.$lazy($,"random","Y4","pa",function(){return P.r2(333)})
...
init.metadata=[{func:"WD",args:[P.qU]},{func:"NT"},{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"X0",void:true},{func:"Ib",ret:P.a2,args:[null,null]},{func:"bX",ret:P.KN,args:[null]},{func:"uJ",ret:P.a,args:[null]},{func:"Dl",ret:P.KN,args:[P.fR,P.fR]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"ZY",ret:P.KN,args:[P.a]},{func:"Vv",ret:P.a2,args:[W.cv,P.qU,P.qU,W.JQ]},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,P.qU]},{func:"bk",args:[W.ew]},{func:"G5",void:true,args:[null]},{func:"Xd",void:true,args:[P.CP]},{func:"bB",void:true,args:[W.Aj]},{func:"xO",args:[{func:"X0",void:true}]},{func:"mQ",void:true,args:[null],opt:[P.mE]},,{func:"yV",args:[null],opt:[null]},{func:"Uf",ret:P.a2},{func:"bb",args:[null,P.mE]},{func:"Za",args:[P.qU,null]},{func:"lv",args:[P.wv,null]},{func:"Cu",ret:P.qU,args:[P.KN]},{func:"qu",void:true,args:[W.KV]},];$=null
...
if(typeof dartMainRunner==="function"){dartMainRunner(function(b){H.Rq(S.KW(),b)},[])}else{(function(b){H.Rq(S.KW(),b)})([])}})
})()
