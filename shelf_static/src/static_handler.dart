...
/// served.
Handler createStaticHandler(String fileSystemPath, {bool serveFilesOutsidePath: false, String defaultDocument}) {
  var rootDir = new Directory(fileSystemPath);
  if (!rootDir.existsSync()) {
    throw new ArgumentError('A directory corresponding to fileSystemPath ' '"$fileSystemPath" could not be found');
  }
...
//    }
    ...
    if (Platform.isWindows) {
      headers = <String, String>{
        ...
        HttpHeaders.LAST_MODIFIED: formatHttpDate(fileStat.modified)
      };
    } else {
      headers = <String, String>{
        HttpHeaders.CONTENT_LENGTH: fileStat.size.toString(),
