...
class MapCanvas {
  ...
  MapCanvas(this.canvas, this.sm, this.canvasWidth, this.canvasHeight) {
    ...
    background = new CanvasElement(width: canvasWidth, height: canvasHeight);
  ...
  void repaint() {
    if (_cycles++ % 60 == 0) {
      ...
      ctx.clearRect(borders.x - 80, borders.y - 80, borders.width + 160,
          borders.height + 160);
    }
